...
if args.lr_finder or args.lr_finder_validation:
    ...
    if args.scheduler == 'StepLR':
        ...
        scheduler = optim.lr_scheduler.OneCycleLR(optimizer, max_lr=0.03,total_steps=len(train_loader)*args.epochs, epochs=args.epochs,verbose=False,pct_start=0.166,div_factor=100,final_div_factor=1)
