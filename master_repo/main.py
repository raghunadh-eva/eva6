...
if args.lr_finder or args.lr_finder_validation:
    ...
    if args.scheduler == 'StepLR':
        ...
        #scheduler = optim.lr_scheduler.OneCycleLR(optimizer, max_lr=0.02, div_factor=20,final_div_factor=1,steps_per_epoch=len(train_loader), epochs=args.epochs,verbose=False)
        scheduler = optim.lr_scheduler.CyclicLR(optimizer, max_lr=0.006,step_size_up=392, step_size_down=1862,scale_mode="iterations",base_lr=0.002,verbose=False)
